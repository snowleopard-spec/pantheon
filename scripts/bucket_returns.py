...
<style>
  ...
  table.constituents th.sortable:hover {{ background: #262d38; }}
  table.constituents th.sortable::after {{
    content: " \\2195";
    color: #4b5563;
    font-size: 0.7rem;
  }}
  table.constituents th.sorted-asc::after {{ content: " \\25B2"; color: #56d364; }}
  table.constituents th.sorted-desc::after {{ content: " \\25BC"; color: #56d364; }}
  td.n {{
    text-align: right;
    color: #8b949e;
    font-size: 0.85rem;
